...
core:
		...
		g++ -g3 -I./include/ -combine ./config/SentryConfigSection.cpp ./config/SentryConfig.cpp ./exceptions/NoSuchLibraryException.cpp ./exceptions/NoSuchSymbolException.cpp \
